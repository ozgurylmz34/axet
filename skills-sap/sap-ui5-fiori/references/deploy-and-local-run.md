...
- deny (paket yöneticisi yolları, 2026-09-24): `npm`/`pnpm` `run`/`run-script` (bayraklı ve `-w`/`--prefix`/`.cmd`
  biçimleri dahil) · `yarn`/`bun` ile `deploy` ve her `undeploy` script'i · `ui5 build … ui5-deploy.yaml` (özel görev
